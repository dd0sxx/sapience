...
This guide builds on the Forecasting Agent. First, complete the [Forecasting Agent](/guides/forecasting-agent) to set up a basic forecasting agent. Then, we'll add a minimal $1 trading flow using the Quoter API and execute trades in a bot "action".
