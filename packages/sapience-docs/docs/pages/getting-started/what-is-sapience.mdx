...
- Lightning-fast builder path: [spin up your first bot in minutes](/guides/forecasting-bots)
...
- Two onchain market designs for different liquidity profiles. See [Market Types](/concepts/market-types).
