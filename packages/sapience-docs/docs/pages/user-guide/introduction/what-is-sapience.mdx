...
We believe recent developments in artificial intelligence have unlocked a new design space: *research agents*. Prediction markets can incentivize their development and help society anticipate—and prepare for—the future. Our [developer tools](https://www.sapience.xyz/bots) are designed for hobbyists with no programming experience as well as professional trading desks.
