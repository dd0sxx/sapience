...
**Core Features:**
- 🤖 **AI Analysis**: Uses GPT-4 to analyze prediction markets
- 📊 **Market Monitoring**: Continuously scans Sapience Protocol markets
- 🔗 **Blockchain Integration**: Creates attestations on Ethereum networks
...
🤖 Found 15 active markets to analyze
...
- It generates probability assessments using GPT-4 and real-time research
