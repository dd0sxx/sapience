...
- Lightning-fast builder path: [spin up your first bot in minutes](/builder-guide/guides/forecasting-agent)
- Public, open source APIs: [GraphQL](/builder-guide/api/graphql) (for market data), [Quoter](/builder-guide/api/quoter) (for sizing orders), [Batch Auction Relayer](/builder-guide/api/auction-relayer) (for RFQ-style markets), [MCP](/builder-guide/api/mcp) (for AI agent tools)
