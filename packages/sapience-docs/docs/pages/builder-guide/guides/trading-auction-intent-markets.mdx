...
This guide walks you through integrating with the Auction Relayer to submit competitive, time-bound bids. You will:

- Connect to the WebSocket
- Listen for `auction.started`
- Submit `bid.submit` with a short deadline and a signature placeholder

For deeper details, see Reference → Auction Relayer.
...
- Message details, validation, and typed signatures: `[Auction Relayer Reference](/builder-guide/reference/auction-relayer)`
