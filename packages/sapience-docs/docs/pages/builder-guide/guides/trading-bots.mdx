...
This guide builds on the [Forecasting Agent](/builder-guide/guides/forecasting-agent) guide. Here, we'll add a minimal $1 trading flow using the Quoter API and execute trades in an agent "action".
