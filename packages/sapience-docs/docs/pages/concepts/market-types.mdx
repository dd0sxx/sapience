...
### Limit-like Execution (CLOB)

- Emulate limits by quoting at target prices and refreshing/cancelling as needed from your bot
- Match occurs continuously against available liquidity; your bot enforces price discipline
- See Guides → CLOB Trading Bot for tactics to emulate limit orders
