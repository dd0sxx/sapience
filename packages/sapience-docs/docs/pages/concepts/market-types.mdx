---
title: Market Types
description: Compare Order Book Markets (CLOB-like) and Batch Auction Markets, and how to express limit-like intent in each.
---

# Market Types

Sapience supports two complementary market designs that can both be traded programmatically and via UI.
